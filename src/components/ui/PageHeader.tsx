  ...
  return (
    <header className="flex flex-col gap-4 pb-5 pt-4 sm:flex-row sm:items-end sm:justify-between">
      <div className="max-w-2xl">
        {eyebrow ? <p className="text-sm font-bold text-[#15508A]">{eyebrow}</p> : null}
      ...
      <div className="flex shrink-0 items-center gap-3 sm:self-end">
        <span className="grid h-16 w-36 place-items-center rounded-xl border border-[#E0F9FA] bg-white px-2 shadow-sm shadow-[#15508A]/8 sm:h-20 sm:w-44">
